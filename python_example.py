...
# kmclass_dll_path = 'C:\\Users\\Screwdriver\\Desktop\\python\\github\\oddang\\oddangam\\driver\\win10\\kmclassdll.dll'
# kmclass_driver_path = b'C:\\Users\\Screwdriver\\Desktop\\python\\github\\oddang\\oddangam\\driver\\win10\\kmclass.sys'
# dll_path = 'D:\\gitRepo\\kmclassdll\\x64\\Debug\\kmclassdll.dll'
# driver_path = b'D:\\gitRepo\\kmclass\\x64\\Debug\\kmclass.sys'
dll_path = 'C:\\Users\\Screwdriver\\Desktop\\python\\github\\oddang\\oddangam\\kmclassdll-x64\\kmclassdll.dll'
driver_path = b'C:\\Users\\Screwdriver\\Desktop\\python\\github\\oddang\\oddangam\\kmclass-x64\\kmclass\\kmclass.sys'
...
if __name__ == '__main__' : 
    ...
    for i in range(10):        
        ...
        _move_rel(111,44)
        time.sleep(.1)
    print(f'unloading driver1')
    unload_driver()
    print(f'unloading driver2')
    time.sleep(.1)
    unload_driver()
    print(f'unloaded driver')